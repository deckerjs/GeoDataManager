...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" minScale="100000000" simplifyMaxScale="1" readOnly="0" simplifyLocal="1" version="3.16.0-Hannover" labelsEnabled="0" simplifyDrawingHints="1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{fae7e334-21c4-4cc5-94e2-789531de03f6}">
      <rule symbol="0" checkstate="0" key="{e5ca5079-6138-4e7c-a0b6-4d8ecba20872}"/>
      <rule filter="&quot;operator&quot; =  'United States Forest Service' OR &quot;operator&quot; =  'US Forest Service'" label="nat forest" symbol="1" key="{6c09097a-0fef-465e-a179-a18415411081}"/>
      <rule filter=" &quot;boundary&quot; = 'protected_area' AND  (&quot;operator&quot; = 'BLM'  OR &quot;operator&quot; =  'BLM; USFS')" label="blm land" symbol="2" key="{40211d0a-ba88-48df-a6b5-d4e6c41f9237}"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" force_rhr="0" name="1">
        <layer class="SimpleFill" locked="0" enabled="1" pass="0">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="157,185,169,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
      ...
      <symbol alpha="0.514" type="fill" clip_to_extent="1" force_rhr="0" name="2">
        <layer class="SimpleFill" locked="0" enabled="1" pass="0">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="201,186,165,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
  ...
  <DiagramLayerSettings placement="1" zIndex="0" priority="0" linePlacementFlags="18" dist="0" showAll="1" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
