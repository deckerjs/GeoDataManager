...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" minScale="100000000" simplifyMaxScale="1" readOnly="0" simplifyLocal="1" version="3.16.0-Hannover" labelsEnabled="0" simplifyDrawingHints="1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" maxScale="0">
  <flags>
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{aa91593d-0b6f-49f6-8a81-8c97008d76c0}">
      <rule label="tracks" symbol="0" scalemaxdenom="463593" scalemindenom="500" key="{85a6cfaf-96ec-4666-99df-e9437f71a865}"/>
      <rule filter=" &quot;surface&quot; IN ('dirt', 'earth','fine gravel',  'fine_gravel',  'grass',  'gravel', 'gravel;ground',  'ground','loose_rock',  'loose_shale',  'mud','pebblestone', 'rock',  'rocks',  'rocky',  'sand',  'stone',  'stone_dust',  'track',  'trail',  'umpaved',  'unpaved' , 'unpaved;paved',  'Unpaved_Road',  'very_horrible')" label="unpaved" symbol="1" scalemaxdenom="463593" scalemindenom="500" key="{7a3d028a-b4cf-4cc4-8b8e-6227021a73a3}"/>
    </rules>
    <symbols>
      <symbol alpha="0.484" type="line" clip_to_extent="1" force_rhr="0" name="0">
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" force_rhr="0" name="1">
        <layer class="SimpleLine" locked="0" enabled="1" pass="0">
          ...
          <prop v="90,48,37,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.66" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
  ...
  <DiagramLayerSettings placement="2" zIndex="0" priority="0" linePlacementFlags="18" dist="0" showAll="1" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="embankment" index="23" name=""/>
    <alias field="foot" index="24" name=""/>
    <alias field="generator:source" index="25" name=""/>
    <alias field="harbour" index="26" name=""/>
    <alias field="highway" index="27" name=""/>
    <alias field="historic" index="28" name=""/>
    <alias field="horse" index="29" name=""/>
    <alias field="intermittent" index="30" name=""/>
    <alias field="junction" index="31" name=""/>
    <alias field="landuse" index="32" name=""/>
    <alias field="layer" index="33" name=""/>
    <alias field="leisure" index="34" name=""/>
    <alias field="lock" index="35" name=""/>
    <alias field="man_made" index="36" name=""/>
    <alias field="military" index="37" name=""/>
    <alias field="motorcar" index="38" name=""/>
    <alias field="name" index="39" name=""/>
    <alias field="natural" index="40" name=""/>
    <alias field="office" index="41" name=""/>
    <alias field="oneway" index="42" name=""/>
    <alias field="operator" index="43" name=""/>
    <alias field="place" index="44" name=""/>
    <alias field="population" index="45" name=""/>
    <alias field="power" index="46" name=""/>
    <alias field="power_source" index="47" name=""/>
    <alias field="public_transport" index="48" name=""/>
    <alias field="railway" index="49" name=""/>
    <alias field="ref" index="50" name=""/>
    <alias field="religion" index="51" name=""/>
    <alias field="route" index="52" name=""/>
    <alias field="service" index="53" name=""/>
    <alias field="shop" index="54" name=""/>
    <alias field="sport" index="55" name=""/>
    <alias field="surface" index="56" name=""/>
    <alias field="toll" index="57" name=""/>
    <alias field="tourism" index="58" name=""/>
    <alias field="tower:type" index="59" name=""/>
    <alias field="tracktype" index="60" name=""/>
    ...
    <alias field="way_area" index="68" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="tracktype" constraints="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="way_area" constraints="0" exp_strength="0"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column width="-1" type="field" hidden="0" name="tracktype"/>
      ...
      <column width="-1" type="field" hidden="0" name="way_area"/>
