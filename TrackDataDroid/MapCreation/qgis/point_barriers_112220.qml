...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" minScale="100000000" simplifyMaxScale="1" readOnly="0" simplifyLocal="1" version="3.16.0-Hannover" labelsEnabled="0" simplifyDrawingHints="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" maxScale="0">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <temporal mode="0" endField="" startField="" durationUnit="min" fixedDuration="0" accumulate="0" startExpression="" endExpression="" enabled="0" durationField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{51da25f0-d3f3-4ec0-9bdf-49e1d6771766}">
      <rule filter=" &quot;barrier&quot;  IN  ('animal_gate', 'chain' , 'cycle_barrier' , 'fence' , 'gate' , 'kissing_gate' , 'lift_gate' , 'swing_gate')" label="gate" symbol="0" scalemaxdenom="28975" scalemindenom="500" key="{f680d756-8029-4b17-b381-fa3e5c9f51dd}"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="marker" clip_to_extent="1" force_rhr="0" name="0">
        <layer class="SvgMarker" locked="0" enabled="1" pass="0">
          ...
          <prop v="transport/barrier_stile.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory sizeScale="3x:0,0,0,0,0,0" barWidth="5" spacing="5" penAlpha="255" diagramOrientation="Up" penWidth="0" sizeType="MM" width="15" spacingUnitScale="3x:0,0,0,0,0,0" showAxis="1" penColor="#000000" height="15" opacity="1" backgroundAlpha="255" maxScaleDenominator="1e+08" scaleDependency="Area" spacingUnit="MM" labelPlacementMethod="XHeight" scaleBasedVisibility="0" lineSizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" enabled="0" direction="0" backgroundColor="#ffffff" minimumSize="0" lineSizeType="MM" rotationOffset="270">
  ...
  <DiagramLayerSettings placement="0" zIndex="0" priority="0" linePlacementFlags="18" dist="0" showAll="1" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="access" index="2" name=""/>
    <alias field="addr:housename" index="3" name=""/>
    <alias field="addr:housenumber" index="4" name=""/>
    <alias field="addr:interpolation" index="5" name=""/>
    <alias field="admin_level" index="6" name=""/>
    <alias field="aerialway" index="7" name=""/>
    <alias field="aeroway" index="8" name=""/>
    <alias field="amenity" index="9" name=""/>
    <alias field="area" index="10" name=""/>
    <alias field="barrier" index="11" name=""/>
    <alias field="bicycle" index="12" name=""/>
    <alias field="brand" index="13" name=""/>
    <alias field="bridge" index="14" name=""/>
    <alias field="boundary" index="15" name=""/>
    <alias field="building" index="16" name=""/>
    <alias field="capital" index="17" name=""/>
    <alias field="construction" index="18" name=""/>
    <alias field="covered" index="19" name=""/>
    <alias field="culvert" index="20" name=""/>
    <alias field="cutting" index="21" name=""/>
    <alias field="denomination" index="22" name=""/>
    <alias field="disused" index="23" name=""/>
    <alias field="ele" index="24" name=""/>
    <alias field="embankment" index="25" name=""/>
    <alias field="foot" index="26" name=""/>
    <alias field="generator:source" index="27" name=""/>
    <alias field="harbour" index="28" name=""/>
    <alias field="highway" index="29" name=""/>
    <alias field="historic" index="30" name=""/>
    <alias field="horse" index="31" name=""/>
    <alias field="intermittent" index="32" name=""/>
    <alias field="junction" index="33" name=""/>
    <alias field="landuse" index="34" name=""/>
    <alias field="layer" index="35" name=""/>
    <alias field="leisure" index="36" name=""/>
    <alias field="lock" index="37" name=""/>
    <alias field="man_made" index="38" name=""/>
    <alias field="military" index="39" name=""/>
    <alias field="motorcar" index="40" name=""/>
    <alias field="name" index="41" name=""/>
    <alias field="natural" index="42" name=""/>
    <alias field="office" index="43" name=""/>
    <alias field="oneway" index="44" name=""/>
    <alias field="operator" index="45" name=""/>
    <alias field="place" index="46" name=""/>
    <alias field="population" index="47" name=""/>
    <alias field="power" index="48" name=""/>
    <alias field="power_source" index="49" name=""/>
    <alias field="public_transport" index="50" name=""/>
    <alias field="railway" index="51" name=""/>
    <alias field="ref" index="52" name=""/>
    <alias field="religion" index="53" name=""/>
    <alias field="route" index="54" name=""/>
    <alias field="service" index="55" name=""/>
    <alias field="shop" index="56" name=""/>
    <alias field="sport" index="57" name=""/>
    <alias field="surface" index="58" name=""/>
    <alias field="toll" index="59" name=""/>
    <alias field="tourism" index="60" name=""/>
    <alias field="tower:type" index="61" name=""/>
    <alias field="tunnel" index="62" name=""/>
    <alias field="water" index="63" name=""/>
    <alias field="waterway" index="64" name=""/>
    <alias field="wetland" index="65" name=""/>
    <alias field="width" index="66" name=""/>
    <alias field="wood" index="67" name=""/>
    <alias field="z_order" index="68" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint unique_strength="1" notnull_strength="1" field="osm_id" constraints="3" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="access" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="addr:housename" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="addr:housenumber" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="addr:interpolation" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="admin_level" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="aerialway" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="aeroway" constraints="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="barrier" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="bicycle" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="brand" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="bridge" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="boundary" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="building" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="capital" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="construction" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="covered" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="culvert" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="cutting" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="denomination" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="disused" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="ele" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="embankment" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="foot" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="generator:source" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="harbour" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="highway" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="historic" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="horse" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="intermittent" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="junction" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="landuse" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="layer" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="leisure" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="lock" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="man_made" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="military" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="motorcar" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="name" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="natural" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="office" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="oneway" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="operator" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="place" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="population" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="power" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="power_source" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="public_transport" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="railway" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="ref" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="religion" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="route" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="service" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="shop" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="sport" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="surface" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="toll" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="tourism" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="tower:type" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="tunnel" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="water" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="waterway" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="wetland" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="width" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="wood" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="z_order" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="capital"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column width="-1" type="field" hidden="0" name="addr:housename"/>
      <column width="-1" type="field" hidden="0" name="addr:housenumber"/>
      <column width="-1" type="field" hidden="0" name="addr:interpolation"/>
      <column width="-1" type="field" hidden="0" name="admin_level"/>
      <column width="-1" type="field" hidden="0" name="aerialway"/>
      ...
      <column width="-1" type="field" hidden="0" name="bicycle"/>
      ...
      <column width="-1" type="field" hidden="0" name="capital"/>
      <column width="-1" type="field" hidden="0" name="construction"/>
      <column width="-1" type="field" hidden="0" name="covered"/>
      <column width="-1" type="field" hidden="0" name="culvert"/>
      <column width="-1" type="field" hidden="0" name="cutting"/>
      <column width="-1" type="field" hidden="0" name="denomination"/>
      <column width="-1" type="field" hidden="0" name="disused"/>
      <column width="-1" type="field" hidden="0" name="ele"/>
      <column width="-1" type="field" hidden="0" name="embankment"/>
      <column width="-1" type="field" hidden="0" name="foot"/>
      <column width="-1" type="field" hidden="0" name="generator:source"/>
      <column width="-1" type="field" hidden="0" name="harbour"/>
      <column width="-1" type="field" hidden="0" name="highway"/>
      <column width="-1" type="field" hidden="0" name="historic"/>
      <column width="-1" type="field" hidden="0" name="horse"/>
      <column width="-1" type="field" hidden="0" name="intermittent"/>
      <column width="-1" type="field" hidden="0" name="junction"/>
      ...
      <column width="-1" type="field" hidden="0" name="power"/>
      <column width="-1" type="field" hidden="0" name="power_source"/>
      <column width="-1" type="field" hidden="0" name="public_transport"/>
      <column width="-1" type="field" hidden="0" name="railway"/>
      <column width="-1" type="field" hidden="0" name="ref"/>
      <column width="-1" type="field" hidden="0" name="religion"/>
      <column width="-1" type="field" hidden="0" name="route"/>
      <column width="-1" type="field" hidden="0" name="service"/>
      ...
      <column width="-1" type="field" hidden="0" name="toll"/>
      <column width="-1" type="field" hidden="0" name="tourism"/>
      <column width="-1" type="field" hidden="0" name="tower:type"/>
      <column width="-1" type="field" hidden="0" name="tunnel"/>
      <column width="-1" type="field" hidden="0" name="water"/>
      <column width="-1" type="field" hidden="0" name="waterway"/>
      <column width="-1" type="field" hidden="0" name="wetland"/>
      <column width="-1" type="field" hidden="0" name="width"/>
      <column width="-1" type="field" hidden="0" name="wood"/>
      <column width="-1" type="field" hidden="0" name="z_order"/>
